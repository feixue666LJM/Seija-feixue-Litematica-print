...
import com.seija.printer.print_main.printer.extra_setting.ExtraSettingManager;
import com.seija.printer.print_main.printer.placedata_getter.PlaceDataManager;
import com.seija.printer.print_main.printer.placedata_getter.vanilla_precision_placer.FakePlacementContext;
import com.seija.printer.print_main.printer.task_manager.RotationManager;
import com.seija.printer.print_main.printer.util.*;
...
//        .build());
    ...
    public final Setting<Boolean> bSetRenderFill = sgRendering.add(new BoolSetting.Builder()
        .name("com.seija.printer.render-fill")
        .defaultValue(true)
...
//
//            textRenderer.com.seija.printer.render(text, -w, 0, Color.BLACK, true);
//
//            textRenderer.end();
//            NametagUtils.end();
//        }
